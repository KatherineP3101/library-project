...
//
//    @Override
//    public AuthorDto getAuthorByNameV2(String name) throws NameNotFoundInDatabaseException {
//        Author author = authorRepository.getAuthorByNameSql(name);
//        return convertToDto(author);
//    }
//
//    @Override
//    public List<AuthorDto> getAuthorByNameV3(String name) throws NameNotFoundInDatabaseException {
//
